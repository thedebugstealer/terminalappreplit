...
echo "[MK8] Updating apt and installing base packages..."
...
echo "[MK8] Upgrading pip..."
python3 -m pip install --upgrade pip

echo "[MK8] Installing Buildozer with full verbosity..."
pip install --user --upgrade cython buildozer virtualenv --verbose

echo "[MK8] Adding Python user bin to PATH..."
echo "$HOME/.local/bin" >> $GITHUB_PATH
export PATH="$HOME/.local/bin:$PATH"

echo "[MK8] Checking Buildozer installation..."
ls -al "$HOME/.local/bin"
which buildozer || echo "[MK8] Buildozer not found in PATH"
buildozer --version || echo "[MK8] Buildozer failed to run"

echo "[MK8] Creating Android SDK directories..."
...
echo "[MK8] Downloading Android commandline tools..."
cd /home/runner
...
echo "[MK8] Installing Android SDK components..."
